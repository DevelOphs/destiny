                  ...
                  <tbody className="divide-y divide-gray-100 text-gray-500">
                    {filteredProducts.map((p) => (
                      <tr key={p.id} className="hover:bg-lightnavy/10 transition-colors duration-150">
                        ...
                        <td className="p-4 text-center space-x-2 select-none">
                          <button
                          ...
                          <button
                            ...
                            className="text-xs font-bold text-red-500 hover:text-white border border-red/20 hover:bg-red/80 py-1.5 px-3 rounded-lg"
